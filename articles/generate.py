...
"""
        ...
        print("Creating related articles section")
        htmlfile.write("\t\t<div class='related-articles'>\n") # Related articles section.
        htmlfile.write("\t\t\t<h1 class='related-articles-heading'>Related Articles</h1>")
        for article in data["related_articles"]: # Create read button for each link.
            htmlfile.write(f"""
\t\t\t<div class="related-article">
\t\t\t\t<p>{article[0]}</p>
\t\t\t\t<a href="{article[1]}" download><button class="read-article-btn">Read</button></a>
\t\t\t</div>
""")
